...
<script type="text/javascript">
	...
	function send(controller){
		...
		$.ajax({
			type: 'post',
			url:'<%=basePath%>rocket/'+controller,
			dataType:'text',
...
<body>
	<h1>Hello RocketMQ</h1>
	<div id="producer">
		<h2>Producer</h2>
		<textarea id="message"></textarea>
		<br>
		<button onclick="send('spring')">主题rocket-spring-topic</button>
		<button onclick="send('springb')">主题rocket-spring-topic-b</button>
		<br>
		<span id="status"></span>
	</div>
</body>
